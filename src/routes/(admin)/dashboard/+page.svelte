...
<section class="">
  <div class="mx-auto lg:flex lg:h-screen lg:items-center">
    <div class="mx-auto max-w-xl text-center">
      ...
      <div class="mt-8 flex flex-wrap justify-center gap-4">
        <a
          class="block w-full rounded bg-green-600 px-12 py-3 text-sm font-medium text-white shadow hover:bg-red-700 focus:outline-none focus:ring active:bg-red-500 sm:w-auto"
          href="/get-started"
        >
          Get Started
        </a>
